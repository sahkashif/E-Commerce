                    ...
                    <div class="blog_wrapper">
                        ...
                        <div class="blog_wrapper_inner">
                            <article class="single_blog">
                                <figure>
                                    <div class="blog_thumb">
                                        <a href="blog-details.html"><img src="{{ asset('img/blog/blogpage3.jpg') }}" alt=""></a>
                                    </div>
                                    <figcaption class="blog_content">
                                       <h4 class="post_title"><a href="blog-details.html">Our Studios</a></h4> <br>
                            ...
                            <article class="single_blog single_blog_gallery">
                                <figure>
                                    <div class="blog_thumb blog_thumb_active owl-carousel">
                                        ...
                                        <div class="single_blog_thumb">
                                            <a href="#"><img src="{{ asset('/img/blog/blogpage5.jpg') }}" alt=""></a>
                                        </div>
                                    </div>
                                    <figcaption class="blog_content">
                                       <h4 class="post_title"><a href="blog-details.html">Recording Facilities</a></h4> <br>
                            ...
                            <article class="single_blog">
                                <figure>
                                    <div class="blog_thumb">
                                        <a href="blog-details.html"><img src="{{ asset('img/blog/blogpage2.jpg') }}" alt=""></a>
                                    </div>
                                    <figcaption class="blog_content">
                                       <h4 class="post_title"><a href="blog-details.html">Audio Production</a></h4>
                                        ...
                                        <p class="post_desc">  Aenean posuere libero eu augue condimentum rhoncus. Praesent ornare tortor ac ante egestas hendrerit. Aliquam et is </p>
                                        <footer class="btn_more">
                                            <a href="blog-details.html"> Get Quotation</a>
                                        </footer>
                                    </figcaption>
                                </figure>
                            </article>
                            <article class="single_blog blog_bidio">
                                <figure>
                                    ...
                                    <figcaption class="blog_content">
                                       <h4 class="post_title"><a href="blog-details.html">Visual Production</a></h4> <br>
                            ...
                            <article class="single_blog">
                                <figure>
                                    <div class="blog_thumb">
                                        <a href="blog-details.html"><img src="{{ asset('img/blog/blogpage4.jpg') }}" alt=""></a>
                                    </div>
                                    <figcaption class="blog_content">
                                       <h4 class="post_title"><a href="blog-details.html">Rehearsal Sessions</a></h4> <br>
                            ...
                            <article class="single_blog">
                                <figure>
                                    <div class="blog_thumb">
                                        <a href="blog-details.html"><img src="{{ asset('img/blog/blogpage5.jpg') }}" alt=""></a>
                                    </div>
                                    <figcaption class="blog_content">
                                       <h4 class="post_title"><a href="blog-details.html">live events</a></h4> <br>
                            ...
                            <article class="single_blog">
                                    <figure>
                                        <div class="blog_thumb">
                                            <a href="blog-details.html"><img src="{{ asset('img/blog/blogpage6.jpg') }}" alt=""></a>
                                        </div>
                                        <figcaption class="blog_content">
                                           <h4 class="post_title"><a href="blog-details.html">Become a member</a></h4> <br>
                                          
                                            <p class="post_desc">Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere libero eu augue condimentum rhoncus. Praesent ornare tortor ac ante egestas hendrerit. Aliquam et metus pharetra, bibendum massa nec, fermentum odio. Nunc id leo ultrices, mollis ligula in, finibus tortor. Mauris</p>
                                            <footer class="btn_more">
                                                <a href="blog-details.html"> Become a Member</a>
                                            </footer>
                                        </figcaption>
                                    </figure>
                                </article>
                    ...
                    <div class="blog_sidebar_widget">
                           ...
                           <div class="widget_title">
                            ...
                            <div class="post_wrapper">
                                <div class="post_thumb">
                                    <a href="blog-details.html"><img src="{{ asset('img/blog/comment2.png.jpg') }}" alt=""></a>
                                </div>
                                <div class="post_info">
                        ...
                        <div class="widget_list banner_area">
                            <div class="banner_thumb">
                                <a href="shop.html"><img src="{{ asset('img/bg/banner15.jpg') }}" alt=""></a>
                            </div>
                        </div>
                        <!--banner area end--> 
